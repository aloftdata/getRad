...
This outlines how to propose a change to getRad. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("aloftdata/getRad", fork = TRUE)`.
...
Please note that the getRad project is released with a [Contributor Code
of Conduct](https://aloftdata.github.io/getRad/CODE_OF_CONDUCT.md). By
