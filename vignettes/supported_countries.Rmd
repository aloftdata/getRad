...
`get_vpts()` can read vertical profile data from the following sources:

### baltrad, uva, ecog-04003

These data are stored on the Aloft bucket. See [details](https://aloftdata.eu/faq/#what-data-are-in-the-bucket).

### rmi

These data are provided by the Royal Meteorological Institute of Belgium (RMI). See [details](https://opendata.meteo.be/geonetwork/srv/eng/catalog.search#/metadata/RMI_DATASET_CROW).
